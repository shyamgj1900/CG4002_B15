...
#define IR_SEND_PIN     2 // Pin 2 is serial output with ATtinySerialOut. Pin 1 is internal LED and Pin3 is USB+ with pullup on Digispark board.
#define TONE_PIN        3
...
#define IR_RECEIVE_PIN      4 // To be compatible with interrupt example, pin 2 is chosen here.
#define IR_SEND_PIN         2
#define TONE_PIN            3
#define APPLICATION_PIN     5
#define ALTERNATIVE_IR_FEEDBACK_LED_PIN 6 // E.g. used for examples which use LED_BUILDIN for example output.
