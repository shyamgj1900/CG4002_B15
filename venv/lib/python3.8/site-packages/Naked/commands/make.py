...
class FileBuilder:
    ...
    def _make_file_paths(self):
        ...
        self.com_initpy = make_path(self.data_container.app_name, 'lib', self.data_container.app_name, 'commands',
                                    '__init__.py')
        ...
        self.lib_proj_initpy = make_path(self.data_container.app_name, 'lib', self.data_container.app_name,
                                         '__init__.py')
